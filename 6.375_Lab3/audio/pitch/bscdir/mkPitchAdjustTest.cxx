...
void MOD_mkPitchAdjustTest::init_symbols_0()
{
  ...
  init_symbol(&symbols[7u], "check", SYM_MODULE, &INST_check);
  init_symbol(&symbols[8u], "feed", SYM_MODULE, &INST_feed);
  init_symbol(&symbols[9u], "passed", SYM_MODULE, &INST_passed);
  init_symbol(&symbols[10u], "RL_c0", SYM_RULE);
  init_symbol(&symbols[11u], "RL_c1", SYM_RULE);
  init_symbol(&symbols[12u], "RL_c2", SYM_RULE);
  init_symbol(&symbols[13u], "RL_f0", SYM_RULE);
  init_symbol(&symbols[14u], "RL_f1", SYM_RULE);
  init_symbol(&symbols[15u], "RL_f2", SYM_RULE);
  init_symbol(&symbols[16u], "RL_finish", SYM_RULE);
  init_symbol(&symbols[17u], "WILL_FIRE_RL_c0", SYM_DEF, &DEF_WILL_FIRE_RL_c0, 1u);
  init_symbol(&symbols[18u], "WILL_FIRE_RL_c1", SYM_DEF, &DEF_WILL_FIRE_RL_c1, 1u);
  init_symbol(&symbols[19u], "WILL_FIRE_RL_c2", SYM_DEF, &DEF_WILL_FIRE_RL_c2, 1u);
  init_symbol(&symbols[20u], "WILL_FIRE_RL_f0", SYM_DEF, &DEF_WILL_FIRE_RL_f0, 1u);
  init_symbol(&symbols[21u], "WILL_FIRE_RL_f1", SYM_DEF, &DEF_WILL_FIRE_RL_f1, 1u);
  init_symbol(&symbols[22u], "WILL_FIRE_RL_f2", SYM_DEF, &DEF_WILL_FIRE_RL_f2, 1u);
  init_symbol(&symbols[23u], "WILL_FIRE_RL_finish", SYM_DEF, &DEF_WILL_FIRE_RL_finish, 1u);
  init_symbol(&symbols[24u], "x__h6481", SYM_DEF, &DEF_x__h6481, 32u);
  init_symbol(&symbols[25u], "x__h6486", SYM_DEF, &DEF_x__h6486, 32u);
}
...
{
  DEF_x__h6481 = INST_feed.METH_read();
  DEF_x__h190 = DEF_x__h6481 + 1u;
  INST_feed.METH_write(DEF_x__h190);
}
...
void MOD_mkPitchAdjustTest::RL_c0()
{
  ...
  DEF_x__h6486 = INST_check.METH_read();
  DEF_signed_0___d10 = 0u;
  DEF_x__h2351 = DEF_x__h6486 + 1u;
  ...
  INST_check.METH_write(DEF_x__h2351);
}
...
void MOD_mkPitchAdjustTest::RL_finish()
{
  ...
  tUInt8 DEF_passed__h6503;
  DEF_passed__h6503 = INST_passed.METH_read();
  DEF_NOT_passed_9___d30 = !DEF_passed__h6503;
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_passed__h6503)
...
unsigned int MOD_mkPitchAdjustTest::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h190", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2351", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6481", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6486", 32u);
...
void MOD_mkPitchAdjustTest::vcd_defs(tVCDDumpType dt, MOD_mkPitchAdjustTest &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_unsigned_DONTCARE___d13 = DEF_unsigned_DONTCARE___d13;
      ...
      ++num;
      if ((backing.DEF_x__h190) != DEF_x__h190)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h190, 32u);
	backing.DEF_x__h190 = DEF_x__h190;
      }
      ++num;
      if ((backing.DEF_x__h2351) != DEF_x__h2351)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2351, 32u);
	backing.DEF_x__h2351 = DEF_x__h2351;
      }
      ++num;
      if ((backing.DEF_x__h6481) != DEF_x__h6481)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6481, 32u);
	backing.DEF_x__h6481 = DEF_x__h6481;
      }
      ++num;
      if ((backing.DEF_x__h6486) != DEF_x__h6486)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6486, 32u);
	backing.DEF_x__h6486 = DEF_x__h6486;
      }
      ++num;
    }
    else
