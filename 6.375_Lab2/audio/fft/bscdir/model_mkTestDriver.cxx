...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_m_inited___d2391;
	 tUInt8 DEF_INST_top_DEF_m_doneread__h626437;
	 tUInt8 DEF_INST_top_DEF_pipeline_fir_infifo_i_notFull____d2399;
	 tUInt32 DEF_INST_top_DEF_x__h627143;
	 ...
	 DEF_INST_top_DEF_x__h627143 = INST_top.INST_m_outstanding.METH_value();
	 DEF_INST_top_DEF_m_doneread__h626437 = INST_top.INST_m_doneread.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_finish = DEF_INST_top_DEF_m_doneread__h626437 && DEF_INST_top_DEF_x__h627143 == 0u;
	 INST_top.DEF_WILL_FIRE_RL_finish = INST_top.DEF_CAN_FIRE_RL_finish;
	 DEF_INST_top_DEF_m_inited___d2391 = INST_top.INST_m_inited.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_init = (INST_top.INST_m_inited_double_write_error.METH_read() && (INST_top.INST_m_in_double_write_error.METH_read() && INST_top.INST_m_out_double_write_error.METH_read())) && !DEF_INST_top_DEF_m_inited___d2391;
	 INST_top.DEF_WILL_FIRE_RL_init = INST_top.DEF_CAN_FIRE_RL_init;
	 DEF_INST_top_DEF_pipeline_fir_infifo_i_notFull____d2399 = INST_top.INST_pipeline_fir_infifo.METH_i_notFull();
	 INST_top.DEF_CAN_FIRE_RL_pad = DEF_INST_top_DEF_pipeline_fir_infifo_i_notFull____d2399 && (DEF_INST_top_DEF_m_inited___d2391 && DEF_INST_top_DEF_m_doneread__h626437);
	 INST_top.DEF_WILL_FIRE_RL_pad = INST_top.DEF_CAN_FIRE_RL_pad;
	 INST_top.DEF_x__h7785 = INST_top.INST_pipeline_chunker_index.METH_read();
	 INST_top.DEF_pipeline_chunker_index_4_EQ_7___d85 = (INST_top.DEF_x__h7785) == (tUInt8)7u;
	 ...
	 INST_top.DEF_CAN_FIRE_RL_read = (INST_top.INST_m_doneread_double_write_error.METH_read() && DEF_INST_top_DEF_pipeline_fir_infifo_i_notFull____d2399) && ((DEF_INST_top_DEF_m_inited___d2391 && !DEF_INST_top_DEF_m_doneread__h626437) && !(DEF_INST_top_DEF_x__h627143 == 4294967295u));
	 INST_top.DEF_WILL_FIRE_RL_read = INST_top.DEF_CAN_FIRE_RL_read;
	 INST_top.DEF_CAN_FIRE_RL_write = INST_top.INST_pipeline_splitter_outfifo.METH_i_notEmpty() && DEF_INST_top_DEF_m_inited___d2391;
...
time_t MODEL_mkTestDriver::get_creation_time()
{
  ...
  /* Thu Apr 18 16:07:30 UTC 2024 */
  return 1713456450llu;
}
